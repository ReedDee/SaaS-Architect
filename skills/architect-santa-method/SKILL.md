...
metadata:
  ...
  vendored_from: "ecc:santa-method"
  license: MIT
  license_holder: "Ronald Skelton; distributed via ECC (© Affaan Mustafa, 2026)"
  vendored_by: architect
  vendor_note: "Bundled P0 dependency of the architect pipeline. See THIRD-PARTY-NOTICES.md."
---
...
| Skill | Relationship |
|-------|-------------|
| Verification Loop | Use for deterministic checks (build, lint, test). Santa for semantic checks (accuracy, hallucinations). Run architect-verification-loop first, Santa second. |
